...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)getTokenWithRequest:(AcceptSDKRequest * __nonnull)inRequest successHandler:(void (^ __nonnull)(AcceptSDKTokenResponse * __nonnull))successHandler failureHandler:(void (^ __nonnull)(AcceptSDKErrorResponse * __nonnull))failureHandler;
@end
